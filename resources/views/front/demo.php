...
<head>
	...
	<title>SGConsultancy | proof Yourself</title>
...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="index.html">PYSC</a>
...
<section class="section-0 lazy d-flex bg-image-style dark align-items-center "   class="" data-bg="assets/images/banner10.JPG">
    <div class="container">
        <div class="row">
...
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6">© 2024 PYSC.com, all right reserved</p>
</div>
</footer> 
