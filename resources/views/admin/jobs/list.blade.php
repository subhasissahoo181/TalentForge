                                    ...
                                    <tbody class="border-0">
                                        @if($jobs->isNotEmpty())
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($job->creates_at)->format('d M, Y')}}</td>
                                                <td>
                                                    <div class="action-dots">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li>
                                                                <a class="dropdown-item" href="{{ route('admin.jobs.edit',$job->id) }}"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a></li>
